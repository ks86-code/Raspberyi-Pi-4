...
##### changed fan settenings KS 21.02.2021
echo '	echo 35"="5 >> $daemonconfigfile' >> $configscript
echo '	echo 40"="8 >> $daemonconfigfile' >> $configscript
echo '	echo 45"="10 >> $daemonconfigfile' >> $configscript
echo '	echo 50"="25 >> $daemonconfigfile' >> $configscript
echo '	echo 55"="45 >> $daemonconfigfile' >> $configscript
echo '	echo 60"="70 >> $daemonconfigfile' >> $configscript
echo '	echo 65"="80 >> $daemonconfigfile' >> $configscript
echo '	echo 70"="90 >> $daemonconfigfile' >> $configscript
echo '	echo 80"="100 >> $daemonconfigfile' >> $configscript
######
